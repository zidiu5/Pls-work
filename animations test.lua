...
- Draggable MainFrame via TitleBar
- Draggable OpenButton always in front
- Open/Close Animation with Position Memory
- Tabs with slide animation
- Dropdowns, buttons, toggles intact
]]
...
-- OpenButton (draggable, always front)
...
OpenButton.ZIndex = 999 -- immer vorne
...
SBList.Changed:Connect(function(prop)
    if prop=="AbsoluteContentSize" then refreshSidebarCanvas() end
end)
...
TitleBar.InputChanged:Connect(dragUpdate)
